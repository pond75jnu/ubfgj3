...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link rel="stylesheet" href="/common/css/meal-precheck.css?v=meal-precheck-06" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="site-content-main site-meal-admin-main">
                ...
                <asp:Panel ID="pnlSummary" runat="server" Visible="false">
                    <div class="site-meal-section-heading">
                        ...
                        <a class="site-button site-button-secondary site-meal-excel-button" href="/staff/mealstatus_excel_export">엑셀 다운로드</a>
                    </div>
    ...
    <asp:Panel ID="pnlDetailModal" runat="server" CssClass="site-meal-modal" Visible="false" role="dialog" aria-modal="true" aria-labelledby="mealDetailTitle" data-meal-modal>
