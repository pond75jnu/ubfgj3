        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-[280px_minmax(0,1fr)]">
            ...
            <div class="min-w-0 rounded-[18px] border border-hairline bg-white p-4 sm:p-6">
                ...
                <div id="divButtons" class="mt-6 flex flex-col gap-2 sm:flex-row sm:flex-wrap">
                    <a id="btnNew" runat="server" href="/staff/retreatdues.aspx?mode=write" class="inline-flex min-h-11 items-center justify-center rounded-pill bg-action px-[22px] py-[11px] text-[17px] font-normal text-white no-underline transition active:scale-95 focus:outline-none focus:ring-2 focus:ring-action-focus">신규
                    </a>
                    ...
                    <a id="btnList" runat="server" href="/staff/retreatdues.aspx" class="inline-flex min-h-11 items-center justify-center rounded-pill border border-action bg-white px-[22px] py-[11px] text-[17px] font-normal text-action no-underline transition active:scale-95 focus:outline-none focus:ring-2 focus:ring-action-focus">목록
                    </a>
