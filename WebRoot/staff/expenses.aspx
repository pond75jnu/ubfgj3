        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-[340px_minmax(0,1fr)]">
            ...
            <div class="min-w-0 space-y-6">
                ...
                <div id="divButtons" class="flex flex-wrap gap-2">
                    <a id="btnNew" runat="server" href="/staff/expenses?mode=write" class="inline-flex min-h-11 items-center justify-center rounded-pill bg-action px-[22px] py-[11px] text-[17px] font-normal text-white transition active:scale-95 focus:outline-none focus:ring-2 focus:ring-action-focus">신규
                    </a>
                    ...
                    <a id="btnList" runat="server" href="/staff/expenses" class="inline-flex min-h-11 items-center justify-center rounded-pill border border-action bg-white px-[22px] py-[11px] text-[17px] font-normal text-action transition active:scale-95 focus:outline-none focus:ring-2 focus:ring-action-focus">목록
                    </a>
